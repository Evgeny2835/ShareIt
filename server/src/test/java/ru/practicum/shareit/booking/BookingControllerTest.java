...
public class BookingControllerTest {
    ...
    void getById_shouldReturnBookingAndAnswer200() throws Exception {
        when(bookingService.getById(USER_ID, BOOKING_ID)).thenReturn(bookingDto);
        when(bookingMapper.toBookingDto(booking)).thenReturn(bookingDto);
    ...
    void approve_shouldAnswer200AndReturnStatusAPPROVEDWhenApprovedIsTrue() throws Exception {
        ...
        when(bookingService.approve(USER_ID, BOOKING_ID, true)).thenReturn(bookingDto);
        when(bookingMapper.toBookingDto(booking)).thenReturn(bookingDto);
    ...
    void approve_shouldAnswer200AndReturnStatusREJECTEDWhenApprovedIsFalse() throws Exception {
        ...
        when(bookingService.approve(USER_ID, BOOKING_ID, false)).thenReturn(bookingDto);
        when(bookingMapper.toBookingDto(booking)).thenReturn(bookingDto);
